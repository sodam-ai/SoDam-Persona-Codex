...
> **지금 버전**: `1.5.1` · **관점 수**: 22명 · **트리거 패턴**: 28개(A~AB) · **스킬 수**: 16개 · **hook 수**: 2개 · **라이선스**: Apache License 2.0
...
- Agent Plugins 1.0 루트 `plugin.json`을 정본으로 추가하고 `.codex-plugin/plugin.json`을 fallback으로 유지했습니다. 현재 세 매니페스트의 버전은 `1.5.1`으로 통일했습니다.
