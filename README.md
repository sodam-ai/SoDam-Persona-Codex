...
**현재 검증 기준(2026-09-17)**: Windows의 Codex CLI `0.154.0` 도움말과 설치·제거 명령 구문을 확인했고, Node.js 20 CI 호환 실행, hook 정상/오류/대용량 입력, Chrome 데스크톱·태블릿·모바일 문서를 확인했습니다. macOS/Linux 실기기와 모든 Codex 앱·IDE 화면 조합은 자동 시험 대상이 아니므로, 그 환경에서는 아래 [설치 확인](#설치-확인)까지 직접 확인하세요.
